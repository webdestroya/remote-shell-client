module github.com/webdestroya/remote-shell-client
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/ec2 v1.54.4 // indirect
	github.com/aws/aws-sdk-go-v2/service/ecs v1.18.19 // indirect
